...
export const get_wishlist_products = createAsyncThunk(
    ...
    async (userId, {
        ...
        try {
            const {
                data
            } = await axios.get(`${base_url}/api/home/product/get-wishlist-products/${userId}`,config)
            return fulfillWithValue(data)
        } catch (error) {
            return rejectWithValue(error.response.data)
        }
...
export const remove_wishlist = createAsyncThunk(
    ...
    async (wishlistId, {
        ...
        try {
            const {
                data
            } = await axios.delete(`${base_url}/api/home/product/delete-wishlist-product/${wishlistId}`,config)
            return fulfillWithValue(data)
        } catch (error) {
            return rejectWithValue(error.response.data)
        }
